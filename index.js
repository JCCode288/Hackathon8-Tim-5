...
let lokasiBtn1 = document.getElementById("lokasiBtn1");
let vaccined = JSON.parse(localStorage.getItem(`person`));
// lokasiBtn1.addEventListener("click", () => {
//   for (const keys in vaccined) {
//   }
// });
console.log(lokasiBtn1);